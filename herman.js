...
module.exports = herman = async (herman, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = herman.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Jaexploit","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/herman3.jpg`)},"title": `© Jaexploit`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Jaexploit", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Jaexploit","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
╰┬———╯          │ ∴°·
 ☆\ˍˍ\_ˍ|—|ˍˍ/ˍˍ/∴☆.`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Jaexploit', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
